// Adapted from frontend/react-export/src/components/EventNotification.jsx —
// the unit was hardcoded to "°C"; now passed in so this works for whichever
// real tag actually triggered the alarm.
...
export default function EventNotification({ notification, onClose, onView }) {
  ...
  return (
    ...
    >
      ...
      <div className="font-heading text-[22px] font-semibold" style={{ color: '#e0554a' }}>
        {notification.value != null ? notification.value.toFixed(1) : '--'} {notification.unit || ''}
      </div>
      <button
        type="button"
        onClick={onView}
