export default function BootScreen({ visible }) {
  return (
    <div
    ...
    >
      ...
      <div className="text-[13px] text-center leading-loose opacity-85">
        ...
        <div className="animate-rf-fadein" style={{ animationDelay: '0.45s' }}>● 3 active assets</div>
        <div className="animate-rf-fadein" style={{ animationDelay: '0.65s' }}>● 8 telemetry tags</div>
        <div className="animate-rf-fadein" style={{ animationDelay: '0.85s' }}>● 0 critical alarms</div>
      </div>
    </div>
  );
}
