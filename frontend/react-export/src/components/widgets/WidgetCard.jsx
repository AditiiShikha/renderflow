...
// Shared frame for every widget: blueprint border, entrance stagger, reason tooltip,
// and the alarm-glow ring critical widgets pick up. type-specific bodies render as children.
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-2.5">
        ...
        <button
          type="button" aria-label="Why this widget" onClick={() => setReasonOpen((v) => !v)}
