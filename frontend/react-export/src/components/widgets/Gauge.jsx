...
export default function Gauge({ widget, value, delayMs }) {
  ...
  const warnPct = ((meta.warn - meta.min) / (meta.max - meta.min)) * 100;
  const critPct = ((meta.crit - meta.min) / (meta.max - meta.min)) * 100;
